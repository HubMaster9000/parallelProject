/*
 * Preprocessor for Netflix movie reviews
 */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
int main() {
    ...
    for (int i = 1; i < nMovies + 1; i++) {
        char file[10] = strcat(i, ".txt");
        char prefix2[30];
        if (i < 10) {
            prefix2[30] = "./data/my_000000";
        }
        else if (i < 100) {
            prefix2[30] = "./data/my_00000";
        }
        else if (i < 1000) {
            prefix2[30] = "./data/my_0000";
        }
        else {
            prefix2[30] = "./data/my_000";
        }
